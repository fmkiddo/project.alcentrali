<html>
<header>
<title>Permintaan Disetujui</title>
</header>
<body>
<div>
<h2>Permintaan Pemindahan Aset Disetujui!</h2>
<p>Permintaan untuk memindahkan aset dengan nomor dokumen <?php echo $document['docnum']; ?>, telah disetujui oleh <?php echo $document['docaction']; ?></p>
...
<tr><td>Status</td><td>:</td><td><b>DISETUJUI</b></td></tr>
...
<br />
<div>
<h2>Asset Transfer Request Approved!</h2>
<p>The request to transfer assets with document number <?php echo $document['docnum']; ?>, has been approved by <?php echo $document['docaction']; ?></p>
...
<tr><td>Status</td><td>:</td><td><b>APPROVED</b></td></tr>
